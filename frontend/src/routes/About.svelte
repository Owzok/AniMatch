  ...
  <div class="menu" class:on={menu_on} class:off={!menu_on} id="menu">
    ...
    <div class="menu-container">
      <div class="sec1">
        ...
        <!--
        <p>
          Each model has its own strengths and weaknesses, for more info click
          <a href="/">here</a>
        </p>
        -->
        ...
        <div class="mult-choice">
          ...
          <div class="choice-el disabled">Perceptron</div>
          <div class="choice-el disabled">Collab. Filtering</div>
        </div>
      </div>
...
.anime-cate-bg{
 background-image: repeating-linear-gradient(45deg, #191919 0, #1f1f1f 86px, #191919 0px, #131313 6%);
}
...
/* Style for the disabled choices */
.disabled {
  ...
  pointer-events: none; /* Prevents clicking or hovering */
