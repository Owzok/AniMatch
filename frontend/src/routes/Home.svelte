...
<body>
    <div class="container">
        ...
        <div class="options">
          ...
          }}>Red Neuronal (Denoising Auto-Encoder)</div>
        </div>
        <div class="interactive-container">
          <p style="color: lightgrey;">Don't have a MyAnimeList account?</p>
          <Link to="interactive"><p class="mal-msg">Try the interactive browser!</p></Link>
        </div>
    </div>
</body>
